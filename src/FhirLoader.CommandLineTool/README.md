...
## Installation
  ...
  2. Clone this repo and open a terminal/command prompt to `src/FhirLoader.CommandLineTool`.
  3. Run `dotnet pack`
  4. Install the tool from disk: `dotnet tool install --global --add-source ./nupkg  FhirLoader.CommandLineTool`
